...
@Component({
  selector: 'page-search-tutor-all-program',
  templateUrl: 'search-tutor-all-program.html'
})
export class SearchTutorAllProgramPage {
	_tutors: any;
	_user_id: string;
	_title: string;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad SearchTutorAllProgramPage');
  }
