...
@Component({
  selector: 'page-presence-list-student',
  templateUrl: 'presence-list-student.html'
})
export class PresenceListStudentPage {
	_translate: any;
	_items: any;
	_enroll_id: string;
	_course: string;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PresenceListStudentPage');
  }

  do_confirm(monitoring_id){
  	var _uri_string = 'http://tutordoors.com/api/course/student_confirm_absence/';
    let body = new FormData();
    body.append('eid', this._enroll_id);
    body.append('monid', monitoring_id);
