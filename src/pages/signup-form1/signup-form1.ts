...
@Component({
  selector: 'page-signup-form1',
  templateUrl: 'signup-form1.html'
})
export class SignupForm1Page {
	_role: any;
	_title: any;
	_provinces: any;
  ...
  constructor(
   ...
   //  });
    ...
    if(translate.currentLang == "id")
      this._uri_string = 'http://tutordoors.com/api/content/feed_page?u=syarat-dan-ketentuan';
    else
      this._uri_string = 'http://tutordoors.com/api/content/feed_page?u=terms-and-conditions';

    this.http.get(this._uri_string)
              .map(res => res.json())
              .subscribe(data => {
    ...
    // get term condition text
    if(translate.currentLang == "id")
      this._uri_string = 'http://tutordoors.com/api/content/feed_page?u=kebijakan-privasi';
    else
      this._uri_string = 'http://tutordoors.com/api/content/feed_page?u=privacy-policy';
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad SignupForm1Page');
  }
  ...
  do_signup(){
    ...
    body.append('source', 'form');
    body.append('email', this._email);
    body.append('level', this._role);
    body.append('password', this._password);
    body.append('passconf', this._password_repeat);
