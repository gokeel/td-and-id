...
export class MailInboxPage {
  ...
  ionViewDidLoad() {
    ...
    this.http.get('http://tutordoors.com/api/messaging/inbox/lang/en/user_id/'+this._user_id+'/start/'+this._limit_start+'/limit/'+this._limit_row).map(res => res.json()).subscribe(data => {
        this._items = data;
